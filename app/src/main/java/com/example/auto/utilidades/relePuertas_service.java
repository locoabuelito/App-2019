...
public class relePuertas_service extends Service {
    ...
    private int icono;
    private static final String CHANNEL_ID = "NOTIFICACION Puertas";
    ...
    public void onCreate() {
        ...
        DatabaseReference dataRef = FirebaseDatabase.getInstance().getReferenceFromUrl("https://app-2019-89860.firebaseio.com/usuario/seccion_rele/rele_puertas");
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        final DatabaseReference dataRef = FirebaseDatabase.getInstance().getReferenceFromUrl("https://app-2019-89860.firebaseio.com/usuario/seccion_rele/rele_puertas");
                ...
                dataRef.addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        ...
                        if (dataSnapshot.exists()) {
                            if (estado) {
                                msjNotificacion = "SEGURO DE LAS PUERTAS HABILITADO";
                                icono = R.drawable.ic_notifications_black_24dp;
                            } else {
                                msjNotificacion = "SEGURO DE LAS PUERTAS DESHABILITADO";
                                icono = R.drawable.ic_notifications_black_24dp;
                            }
